//! BDD test harness for pheno-plugin-vessel.
//!
//! Historically this body was extracted to
//! `phenoShared/crates/phenotype-test-support/src/bdd/steps.rs` as part
//! of a lib-merge across PhenoSchema/pheno-xdd-lib, PhenoSchema/pheno-xdd,
//! and PhenoPlugins/pheno-plugin-vessel. The shared test-support crate
//! is not published, and PhenoPlugins must build standalone, so the
//! shared body is re-vendored here.
