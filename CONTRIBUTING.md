# Contributing to PhenoPlugins

Thanks for your interest in contributing to **PhenoPlugins**, part of the [Phenotype](https://github.com/KooshaPari) ecosystem.
...
```bash
git clone https://github.com/KooshaPari/PhenoPlugins.git
cd PhenoPlugins
